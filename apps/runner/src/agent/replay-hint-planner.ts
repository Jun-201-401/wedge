...
import { ruleBasedAgentPlanner, type AgentDecision, type AgentDecisionInput, type AgentPlanner } from "./planner.ts";

export function createReplayHintPlanner(fallbackPlanner: AgentPlanner = ruleBasedAgentPlanner): AgentPlanner {
  return {
...
function decideFromReplayHints(input: AgentDecisionInput): AgentDecision | null {
...
function resolveReplayStepIndex(input: AgentDecisionInput, replayHints: AgentReplayHints): number {
