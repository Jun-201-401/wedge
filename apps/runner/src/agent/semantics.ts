...
export const plannerSemantics = {
  ...
  checkoutNavigation: /checkout|proceed to checkout|payment|billing|order|buy now|purchase|결제|주문서|주문하기|바로구매|바로 구매|구매하기/i,
  productBrowse: /goods_list|goods_view|\/goods\/|\/products?|\/collections?|\/category|\/catalog|\/shop|product|상품\s*(목록|상세|보기)|상품(목록|상세|보기)|catalog|sku|item/i,
  checkoutNonEntrypoint: /q&a|qa|goodsqa|review|reviews|상품\s*문의|상품문의|문의\s*(전체보기|글쓰기)|문의(전체보기|글쓰기)|후기|리뷰|찜하기|wish|wishlist|최근본|이전\s*상품|다음\s*상품|배송\s*비용\s*참조|배송비용\s*참조|배송비.*클릭|shipping\s*(fee|cost|info|guide)|notice|공지/i,
...
export const verifierSemantics = {
  ...
  productDetailUrl: /goods_view|\/goods\/|\/product\/|\/products\/|\/item\/|\/items\/|sku/i,
  checkoutBoundaryAction: /buy now|order now|purchase|add to cart|cart|basket|바로\s*구매|구매하기|장바구니|카트|담기/i,
  purchaseBoundaryContext: /order summary|quantity|option|required|total|subtotal|price|sale price|purchase|상품금액|총 상품금액|총 합계금액|판매가|옵션|필수|수량|구매혜택|배송비/i,
