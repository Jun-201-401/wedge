...
public class ReportController {
    ...
    @PostMapping("/api/runs/{runId}/reports")
    public ResponseEntity<ApiResponse<ReportExportResponse>> createRunReportExport(
            @PathVariable UUID runId,
            @Valid @RequestBody ReportCreateRequest request,
            Authentication authentication
    ) {
        return ApiResponse.ok(reportExportService.createRunReportExport(runId, principal(authentication).userId(), request));
    }
