...
public class AnalysisController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<AnalysisRequestResponse>> requestAnalysis(@PathVariable UUID runId) {
        return ApiResponse.accepted(analysisRequestService.requestPrimaryAnalysis(runId));
    }
}
