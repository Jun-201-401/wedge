...
test('run monitor css follows the live cockpit visual language', () => {
  ...
  assert.match(css, /\.run-monitor-report-cta--clickable:hover\s*\{[\s\S]*?background: #fff/);
  ...
  assert.match(cssRule(css, '.run-monitor-report-cta--clickable:hover .run-monitor-report-cta__open-icon,\n.run-monitor-report-cta--clickable:focus-visible .run-monitor-report-cta__open-icon'), /animation: run-monitor-report-open-fly 600ms ease-in-out infinite alternate/);
  assert.match(cssRule(css, '.run-monitor-report-cta--clickable:hover .run-monitor-report-cta__open-icon svg,\n.run-monitor-report-cta--clickable:focus-visible .run-monitor-report-cta__open-icon svg'), /transform: translateX\(2\.8em\) rotate\(45deg\) scale\(1\.1\)/);
  assert.match(cssRule(css, '.run-monitor-report-cta--clickable:hover .run-monitor-report-cta__open-text,\n.run-monitor-report-cta--clickable:focus-visible .run-monitor-report-cta__open-text'), /opacity: 0/);
  assert.match(cssRule(css, '.run-monitor-report-cta--clickable:hover .run-monitor-report-cta__open-text,\n.run-monitor-report-cta--clickable:focus-visible .run-monitor-report-cta__open-text'), /transform: translateX\(6\.4em\)/);
