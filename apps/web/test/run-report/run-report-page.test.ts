...
test('run report css keeps result-first content in the live simulation cockpit tone', () => {
  ...
  assert.match(css, /\.run-report-hero\s*\{[\s\S]*?min-height: 5rem/);
  assert.match(css, /\.run-report-hero\s*\{[\s\S]*?padding: 0\.78rem 2rem/);
  assert.match(css, /\.run-report-hero__copy\s*\{[\s\S]*?grid-template-columns: minmax\(0, 1fr\)/);
  assert.match(css, /\.run-report-hero__meta\s*\{[\s\S]*?display: flex/);
  assert.match(css, /\.run-report-hero-context\s*\{[\s\S]*?display: flex/);
  assert.match(css, /\.run-report-hero-context\s*\{[\s\S]*?font-size: 0\.74rem/);
  assert.match(css, /\.run-report-hero-context div \+ div::before\s*\{[\s\S]*?content: '·'/);
  assert.match(css, /\.run-report-tag\s*\{[\s\S]*?font-size: 0\.56rem/);
  assert.match(css, /\.run-report-hero h1\s*\{[\s\S]*?font-size: 1\.02rem/);
  assert.match(css, /\.run-report-hero-context dt\s*\{[\s\S]*?clip-path: inset\(50%\)/);
  assert.match(css, /\.run-report-hero-context dd\s*\{[\s\S]*?display: block/);
  assert.match(css, /\.run-report-hero-context dd\s*\{[\s\S]*?font-size: inherit/);
  assert.match(css, /\.run-report-hero \.run-report-hero__notice\s*\{[\s\S]*?background: rgba\(254, 252, 232, 0\.92\)/);
  assert.match(css, /\.run-report-hero-stats\s*\{[\s\S]*?display: grid/);
  assert.match(css, /\.run-report-hero-stats\s*\{[\s\S]*?grid-template-columns: repeat\(3, max-content\)/);
  ...
  assert.match(css, /\.run-report-hero-stats dt\s*\{[\s\S]*?font-size: 0\.54rem/);
  assert.match(css, /\.run-report-hero-stats dd\s*\{[\s\S]*?font-size: 0\.88rem/);
