    ...
    recommendations: [
      {
        ...
        effort: '낮음',
        validationQuestion: '사용자는 첫 화면에서 3초 안에 주요 CTA를 식별할 수 있나요?',
      },
      {
        id: 'trust-signal',
        ...
        rationale: '사용자가 결정을 내리기 전 확인할 수 있는 증거와 신뢰 신호가 CTA보다 늦게 배치되어 있습니다.',
        expectedImpact: '가입 전환 개선',
        effort: '보통',
        validationQuestion: '사용자는 CTA를 누르기 전 비용과 위험 조건을 이해할 수 있나요?',
      },
      {
        id: 'form-expectation',
        ...
        effort: '낮음',
        validationQuestion: '사용자는 CTA 클릭 전에 다음 단계의 입력 부담을 예측할 수 있나요?',
      },
    ],
  };
}
