...
export function buildMockRunMonitorData(runId: string, startUrl: string, scenarioLabel: string): MockRunMonitorData {
  ...
  return {
    ...
    live: {
      ...
      status: 'RUNNING',
      currentStepOrder: 4,
      currentAction: '주요 버튼 클릭 후 도착 화면 확인 중',
      latestFrame: null,
      latestCheckpoint: {
    ...
    progressPercent: 64,
    currentCheckpoint: '주요 버튼 클릭 후 도착 화면 확인 중',
    previewTitle: 'Make your value clear above the fold',
    previewSubtitle: '첫 화면 · 주요 버튼 감지',
    ...
    steps: [
      ...
      },
      {
        id: 'cta-candidates',
        label: '전환 버튼 후보 감지',
        detail: '주요 버튼과 상단 메뉴 버튼 후보를 비교하고 있습니다.',
        status: 'active',
        timestamp: '10:41:13',
      },
      {
        id: 'cta-click',
        label: '주요 버튼 클릭',
        detail: '선택한 버튼 클릭 후 도착 화면의 맥락을 확인합니다.',
        status: 'pending',
        timestamp: '대기 중',
      },
      {
    ...
    logs: [
      ...
      { id: 'log-3', time: '10:41:09', message: '주요 버튼 후보를 확인했습니다', tone: 'success' },
      { id: 'log-4', time: '10:41:13', message: '선택한 목표와 버튼 흐름을 비교하고 있습니다', tone: 'info' },
