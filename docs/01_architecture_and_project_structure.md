...
7. React renders Scenario Recommendation cards and optional guided custom scenario controls
8. User confirms a recommendation or edits a guided scenario
9. Spring creates test_run with source_discovery_id and materializes ScenarioPlan + fit_requirements
10. Full Run performs scenario fit check before risky/deep actions
11. If fit is applicable, Runner executes ScenarioPlan and collects checkpoint evidence
...
14. Spring creates analysis_job and, for MVP Analyzer integration, publishes analysis.request with the full EvidencePacket inline
...
17. Spring stores analysis_job, rule_hit, analysis_finding, nudge from Analyzer callback; report rows are generated by Spring report API/service from the completed analysis result
